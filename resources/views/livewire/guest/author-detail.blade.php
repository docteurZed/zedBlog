            ...
            <div class="border border-gray-200 dark:border-gray-700 p-8 rounded-4xl bg-white dark:bg-gray-900 text-gray-900 dark:text-white md:flex justify-between w-full">
                <div class="md:flex gap-4 mb-8 md:mb-0">
                    ...
                    <div class="col-span-3 m-3">
                        ...
                        <h2 class="mb-3 text-4xl text-gray-900 dark:text-white font-bold">John Doe</h2>
                        <p class="mb-3 font-normal text-gray-600 dark:text-gray-400 w-full md:w-[80%]">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Cum, commodi. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Et modi dolores facilis consectetur quam aliquam?</p>
